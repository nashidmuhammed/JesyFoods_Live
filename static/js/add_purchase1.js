  ...
  $(document).ready(function() {
    ...
    $('#add_row').click(function(){
        $("#table > tbody:last-child").append(`
                <tr>
                    <td>
                    <input id="autocomplete" type="text" class="autocomplete form-control ui-autocomplete-input" placeholder="Enter Product name"  required>
                    </td>
                    <td><input id="qty" type="number" class="form-control" placeholder="Qty" oninput="add_number()"  required></td>
                    <td><input id="price" type="number" class="form-control "  oninput="add_number()"  required></td>
                    <td><input id="toot" oninput="tot_number()" type="number" class="form-control" placeholder="000.00" required></td>
                </tr>
            `);
